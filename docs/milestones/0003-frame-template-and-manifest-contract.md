...
- **3b — Manifest / frame usage (spec 0003b): Verified.** The manifest contract is verified. Reviewer wiring — reading the manifest's revision limits into reviewer behavior and frame usage through the review milestones — is explicitly out of scope here and remains in downstream milestones 0006/0007.
...
settles the contract the later review milestones (0006, 0007) build on: what is
